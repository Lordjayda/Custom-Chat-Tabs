...
public class TabsScreen extends ScrollableDarkScreen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new DarkButton(
                ...
                () -> Minecraft.getInstance().setScreen(new ScreensMenuScreen(this, serverKey))
        ));
        y += 26;
        ...
        addRenderableWidget(new DarkButton(
                ...
                () -> Minecraft.getInstance().setScreen(new NotificationsScreen(this, serverKey))
        ));
        y += 26;
        ...
        addRenderableWidget(new DarkButton(
                ...
                () -> Minecraft.getInstance().setScreen(new ChatFiltersScreen(this, serverKey))
        ));
        y += 26;
        ...
        addRenderableWidget(new DarkButton(
                ...
                () -> Minecraft.getInstance().setScreen(new TimestampMenuScreen(this, serverKey))
        ));
        y += 26;

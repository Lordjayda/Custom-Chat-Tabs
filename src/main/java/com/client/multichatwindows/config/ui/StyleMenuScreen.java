...
public class StyleMenuScreen extends ScrollableDarkScreen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new DarkButton(
                ...
                () -> Minecraft.getInstance().setScreen(new OutlineMenuScreen(this, serverKey, tabIndex))
        ));
        addRenderableWidget(new DarkButton(
                right,
                y,
                ...
                () -> Minecraft.getInstance().setScreen(new RealTimeEditorScreen(this, serverKey, tabIndex))
        ));
        y += 28;

...
public final class HudOverlay {
    ...
    private static void extractRenderState(GuiGraphicsExtractor ctx, DeltaTracker tickCounter) {
        ...
        if (mc.player == null || com.client.multichatwindows.util.MinecraftGuiAccess.isHudHidden()) return;
    ...
    private static boolean isExpanded(Minecraft mc) {
        return com.client.multichatwindows.util.MinecraftGuiAccess.currentScreen() instanceof ChatScreen;
    }
